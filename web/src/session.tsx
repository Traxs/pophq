...
export function SessionProvider({
  ...
  const api = useMemo(() => {
    ...
    return {
      ...
      addAccountAlias: guard(inner.addAccountAlias),
      ...
      fortressBuffs: guard(inner.fortressBuffs),
      fortressBuff: guard(inner.fortressBuff),
      ...
      assignFortressBuff: guard(inner.assignFortressBuff),
      confirmFortressBuffAssignment: guard(inner.confirmFortressBuffAssignment),

...
export function AgentTokens() {
  ...
  return (
    <section className="card stack" aria-labelledby="agent-token-title">
      <h2 id="agent-token-title" className="section-label">Hermes access</h2>
      <p className="muted small">Issue a dedicated credential for result context, scores and player points. It cannot use other officer routes.</p>
